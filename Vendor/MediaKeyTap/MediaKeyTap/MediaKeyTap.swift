...
public class MediaKeyTap {
    ...
    public static func functionKeyCodeToMediaKey(_ keycode: Keycode) -> MediaKey? {
        ...
        case 79: return .volumeUp // F18 — volume up remapped via hidutil so the system never handles it
        case 80: return .volumeDown // F19 — volume down remapped via hidutil
        case 90: return .mute // F20 — mute remapped via hidutil
        default: return nil
        }
    }
